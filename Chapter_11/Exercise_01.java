...
the triangle is filled. The program should create a Triangle object with these sides and set the color and filled properties using the input.
...
import Chapter_11.Chapter_Classes.Triangle;

public class Exercise_01 {
    public static void main(String[] args) {
        GeometricObject figure = new GeometricObject();
        System.out.println(figure);
        // triangle 1
        //Triangle triangle1 = new Triangle(1, 4, 4);
        ...
        System.out.println(triangle1); // this invokes toString method
        // triangle 2
