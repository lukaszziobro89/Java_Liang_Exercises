...
that February 2012 had 29 days. If the user entered month 3 and year 2015, the program should display that
...
public class Exercise_11 {
    public static void main(String[] args) {
        ...
        switch (month){
            ...
            case 2: System.out.println("February " + year + " had " + (isLeapYear ? "29" : "28")  + " days."); break;
